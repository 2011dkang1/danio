...
function Map() {
  ...
  this.canscroll = true;
  this.floor = 104;
  this.time = 0; // optionally specified later
  this.curloc = -1;
...
function pushPreThing(type, xloc, yloc, extras, more, fact) {
  var prething = new PreThing(map.refx + xloc, map.refy - yloc, type, extras, more, fact),
...
function World11(map) {
  map.locs = [
    ...
    new Location(0, exitPipeVert),// 2: exit second underworld
    new Location(0, exitPipeVert),// 3: exit first underworld
    new Location(0, exitPipeVert),// 4: exit second underworld
    new Location(0, exitPipeVert),// 5: exit first underworld
    new Location(0, exitPipeVert),// 6: exit second underworld

    new Location(1),              // 7: enter first underworld
    new Location(2),              // 8: enter second underworld
    new Location(3),              // 9: enter first underworld
    new Location(4),              // 10: enter second underworld
    new Location(5),              // 11: enter first underworld
    new Location(6)               // 12: enter second underworld
  ...
  map.areas = [
    new Area("Overworld", function() {
      ...
      greeter += "    <span style='font-size:81px;line-height:96px'>DANIO BROS.</span>";
      greeter += "  </p>";
      greeter += "</div>";
      ...
      var inst = "";
      inst += "<div style='width:350px;max-height:189px;background-color:#d64d00;border-radius:7px;box-shadow:3px 3px #efb28b inset, -3px -3px black inset;";
      inst += "background-image: url(\"Theme/Greeting.gif\"), url(\"Theme/Greeting.gif\"), url(\"Theme/Greeting.gif\"), url(\"Theme/Greeting.gif\");";
      inst += "background-repeat: no-repeat;";
      inst += "background-position: 7px 7px, 336px 7px, 7px 168px, 336px 168px";
      inst += "'>";

      inst += "  <p style='text-align:left;padding:7px 0 11px 11px;>";
      inst += "    <br><br>"; // To do: make this not so font dependant
      inst += "    <span style='font-size:24px'>Welcome! Hit the blocks to learn more about me. Have fun!</span>";
      // inst += "    <br><br>"; // To do: make this not so font dependant
      // inst += "    DANIO BROS.";
      inst += "  </p>";
      inst += "</div>";
     ...
     var pipe1 = "";
      ...
      var fact = "";
      fact += "<div style='margin-left:-150px;width:350px;max-height:189px;background-color:#d64d00;border-radius:7px;box-shadow:3px 3px #efb28b inset, -3px -3px black inset;";
      fact += "background-image: url(\"Theme/Greeting.gif\"), url(\"Theme/Greeting.gif\"), url(\"Theme/Greeting.gif\"), url(\"Theme/Greeting.gif\");";
      fact += "background-repeat: no-repeat;";
      fact += "background-position: 7px 7px, 336px 7px, 7px 168px, 336px 168px";
      fact += "'>";
      fact += "  <p style='text-align:left;padding:7px 0 11px 11px;>";
      fact += "    <br><br>"; // To do: make this not so font dependant
      var factBeg = fact;

      // fact += "    <span style='font-size:24px'>My name is Daniel Kang and I am currently pursuing an EECS degree at UC Berkeley.</span>";
      var factEnd = "";
      factEnd += "  </p>";
      factEnd += "</div>";
      ...
      var fact1 = "";
      fact1 += "<div style='margin-left:-150px;width:350px;max-height:189px;background-color:#d64d00;border-radius:7px;box-shadow:3px 3px #efb28b inset, -3px -3px black inset;";
      fact1 += "background-image: url(\"Theme/Greeting.gif\"), url(\"Theme/Greeting.gif\"), url(\"Theme/Greeting.gif\"), url(\"Theme/Greeting.gif\");";
      fact1 += "background-repeat: no-repeat;";
      fact1 += "background-position: 7px 7px, 336px 7px, 7px 168px, 336px 168px";
      fact1 += ";margin-top:0px;'>";
      fact1 += "  <p style='text-align:left;padding:7px 0 11px 11px;>";
      fact1 += "    <br><br>"; // To do: make this not so font dependant
      fact1 += "    <span style='font-size:24px'> I am Daniel Kang </span>";
      fact1 += "  </p>";
      fact1 += "</div>";

      var fact2 = "";
      fact2 += "<div style='margin-left:-180px;width:350px;max-height:189px;background-color:#d64d00;border-radius:7px;box-shadow:3px 3px #efb28b inset, -3px -3px black inset;";
      fact2 += "background-image: url(\"Theme/Greeting.gif\"), url(\"Theme/Greeting.gif\"), url(\"Theme/Greeting.gif\"), url(\"Theme/Greeting.gif\");";
      fact2 += "background-repeat: no-repeat;";
      fact2 += "background-position: 7px 7px, 336px 7px, 7px 168px, 336px 168px";
      ...
      // var fact1 = factBeg;
      // fact1 += "    <span style='font-size:24px'>I'm Daniel Kang</span>";
      // fact1 += factEnd;

      // var fact2 = factBeg;
      // fact2 += "    <span style='font-size:24px'>.</span>";
      // fact2 += factEnd;

      // var fact3 = factBeg;
      // fact3 += "    <span style='font-size:24px'>Here are some of my past projetsw.</span>";
      // fact3 += factEnd;

      var fact4 = factBeg;
      fact4 += "    <span style='font-size:24px'>hi.</span>";
      fact4 += factEnd;

      var fact5 = factBeg;
      fact5 += "    <span style='font-size:24px'>hey.</span>";
      fact5 += factEnd;

      var fact6 = factBeg;
      fact6 += "    <span style='font-size:24px'>I'm a tinkerer, builder, explorer.</span>";
      fact6 += factEnd;
      // var fact6 = factBeg;
      // fact6 += "    <span style='font-size:24px'>.</span>";
      // fact6 += factEnd;

      var fact7 = factBeg;
      fact7 += "    <span style='font-size:24px'>.</span>";
      fact7 += factEnd;


      pushPreText(greeter, 20, 91);
      pushPreText(inst, 20, -15);
      // pushPreThing(Block, 20, jumplev1, [Mushroom, 0] ,false, fact1);
      pushPrePattern("backreg", 0, 0, 5);
      pushPreFloor(0, 0, 69);
      
      pushPreThing(Block, 128, jumplev1);
      pushPreThing(Brick, 160, jumplev1);
      pushPreThing(Block, 168, jumplev1, Mushroom, false, fact1);
      // pushPreThing(Goomba, 176, 8);
      pushPreThing(Brick, 176, jumplev1);
      pushPreThing(Block, 176, jumplev2, Coin, false, fact3);
      ...
      pushPrePipe(304, 0, 24 , false, 8, 2);            //pipe 2


      pushPrePipe(368, 0, 32, false, 9, 3);            // pipe 3

      pushPreThing(Goomba, 340, 8);
      // pushPrePipe(368, 0, 32);            //pipe 
      pushPreThing(Goomba, 412, 8);
      pushPreThing(Goomba, 422, 8);
      pushPrePipe(456, 0, 32, false, 10, 4);  // pipe 4

// function pushPrePipe(xloc, yloc, height, pirhana, intoloc, exitloc) {
      // pushPreThing(Block, 20, jumplev1, [Mushroom, 0] ,false, fact1);
      // pushPreText(fact1, 456, -15);

      pushPreThing(Block, 512, 40, [Mushroom, 1], true);
      pushPreFloor(568, 0, 15);
      pushPreThing(Brick, 618, jumplev1);
      pushPreThing(Block, 626, jumplev1, Mushroom, false, fact4);
      ...
      pushPreThing(Block, 752, jumplev2, Coin, false, fact5);
      pushPreThing(Goomba, 776, 8);
      pushPreThing(Goomba, 788, 8);

      // pushPreText(fact3, 800, -15);
      ...
      pushPreThing(Block, 872, jumplev1, Coin, false, fact6);
      ...
      pushPreThing(Block, 1032, jumplev2, Coin, false, fact7);
      ...
      // pushPreThing(Stone, 1520, 104, 2, 15);
      endCastleOutside(1580, 0, 1);
    }),

    new Area("Underworld", function() {           // underworld 1
      setLocationGeneration(7);

      var fact = "";


      // fact += "<div style = 'position:absolute;margin-top:-100px;'>";
      // fact += "hi this is a test";
      // fact += "</div>";



      fact += "<div style='position:absolute;margin-left:50px;width:900px;height:170px;background-color:#d64d00;border-radius:7px;box-shadow:3px 3px #efb28b inset, -3px -3px black inset;";
      fact += "background-image: url(\"Theme/Greeting.gif\"), url(\"Theme/Greeting.gif\"), url(\"Theme/Greeting.gif\"), url(\"Theme/Greeting.gif\");";
      fact += "background-repeat: no-repeat;";
      ...
      fact += "<div style='position:relative;margin-left:0px;max-width:1000px;max-height:189px;background-color:#d64d00;border-radius:7px;box-shadow:3px 3px #efb28b inset, -3px -3px black inset;";
      fact += "background-image: url(\"Theme/Greeting.gif\"), url(\"Theme/Greeting.gif\"), url(\"Theme/Greeting.gif\"), url(\"Theme/Greeting.gif\");";
      fact += "background-repeat: no-repeat;";
      fact += "background-position: 7px 7px, 986px 7px, 7px 168px, 336px 168px";
      fact += "'>";
      fact += "  <p style='text-align:left;padding:7px 0 11px 11px;>";
      fact += "    <br><br>"; // To do: make this not so font dependant
      var factBeg = fact;
      ...
      makeCeiling(32, 31);
      pushPreFloor(0, 0, 40);
      pushPreThing(Block, 32, jumplev1, Coin, false, fact1);
      fillPreThing(Stone, 40, jumplev1, 30, 1, 8, 8);
      fillPreThing(Stone, 32, jumplev1+8, 1, 6, 8, 8);
      fillPreThing(Stone, 272, jumplev1+8, 1, 6, 8, 8);
      // log(gamescreen.right);
      ...
      pushPreThing(PipeSide, 284, 16, 1);
      // pushPreThing(PipeVertical, 120, 88, 88);
      pushPreThing(PipeVertical, 300, 88, 88);
    }),
  new Area("Underworld", function() {           // underworld 2
    ...
    new Area("Underworld", function() {           // underworld 3
      setLocationGeneration(9);
      makeCeiling(32, 7);
      pushPreFloor(0, 0, 100);
      // fillPreThing(Brick, 0, 8, 1, 11, 8, 8);
      // fillPreThing(Brick, 32, 8, 7, 3, 8, 8);
  ...
  new Area("Underworld", function() {           // underworld 4
      setLocationGeneration(10);
      makeCeiling(32, 7);
      pushPreFloor(0, 0, 100);
      // fillPreThing(Brick, 0, 8, 1, 11, 8, 8);
      // fillPreThing(Brick, 32, 8, 7, 3, 8, 8);
    ...
    new Area("Underworld", function() {           // underworld 5
      setLocationGeneration(11);
      makeCeiling(32, 7);
      pushPreFloor(0, 0, 100);
      // fillPreThing(Brick, 0, 8, 1, 11, 8, 8);
      // fillPreThing(Brick, 32, 8, 7, 3, 8, 8);
      // fillPreThing(Coin, 33, 31, 7, 2, 8, 16);
      // fillPreThing(Coin, 41, 63, 5, 1, 8, 8);
      pushPreThing(PipeSide, 104, 16, 5);
      pushPreThing(PipeVertical, 120, 88, 88);
    }),
  new Area("Underworld", function() {           // underworld 6
      setLocationGeneration(12);
      makeCeiling(32, 7);
      pushPreFloor(0, 0, 100);
      // fillPreThing(Brick, 0, 8, 1, 11, 8, 8);
      // fillPreThing(Brick, 32, 8, 7, 3, 8, 8);
      // fillPreThing(Coin, 33, 31, 7, 2, 8, 16);
      // fillPreThing(Coin, 41, 63, 5, 1, 8, 8);
      pushPreThing(PipeSide, 104, 16, 6);
      pushPreThing(PipeVertical, 120, 88, 88);
    })
